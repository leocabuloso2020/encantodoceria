...
import { Home, Package, LogOut, Heart, DollarSign, ShoppingBag, MessageSquareText } from 'lucide-react';
      ...
      <aside className="w-64 bg-sidebar p-6 border-r border-sidebar-border flex flex-col justify-between">
        <div>
          <div className="flex items-center space-x-2 mb-8">
            ...
            <h2 className="font-dancing text-xl font-bold text-sidebar-foreground">Admin Encanto Doceria</h2>
          </div>
